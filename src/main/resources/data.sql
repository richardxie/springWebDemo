...
/* Product Details */
INSERT INTO PRODUCT_DETAIL (ID,ALREADY_INVEST_PEOPLE,ALREADY_INVEST_AMOUNT,PARTAKE_ORGANIZS,PARTAKE_CRERIGS,ACCUMULATIVE_LUCRE,CURR_USABLE_VALUE,CREATE_USER,CREATE_DATE,LAST_UPDATE_USER,LAST_UPDATE_DATE,VERSION,RECORD_STATUS,CURR_TERM,OPEN_DATE) 
			values ('1',115,3816000,5,18,743513.6144,990320.8930,'admin','2015-11-22','root','2015-12-26',1,'启用','T2016001046','2016-2-12');
INSERT INTO PRODUCT_DETAIL (ID,ALREADY_INVEST_PEOPLE,ALREADY_INVEST_AMOUNT,PARTAKE_ORGANIZS,PARTAKE_CRERIGS,ACCUMULATIVE_LUCRE,CURR_USABLE_VALUE,CREATE_USER,CREATE_DATE,LAST_UPDATE_USER,LAST_UPDATE_DATE,VERSION,RECORD_STATUS,CURR_TERM,OPEN_DATE) 
			values ('2',115,3816000,5,18,743513.6144,990320.8930,'admin','2015-11-22','root','2015-12-26',1,'启用','T2016001046','2016-2-12');
/* Product */
INSERT INTO PRODUCT (ID,RRODUCT_DETAIL_ID,PRODUCT_TYPE,PRODUCT_NAME,PRODUCT_STATUS, YEAR_RATE, PRODUCT_DESC,TYPE_TERM,INVEST_MIN_AMOUNT,INVEST_MAX_AMOUNT,ENABLE_STATUS,CREATE_DATE) 
            values ('1','1','1','月月赢','开放中', 8,'1元起投 随进随出',3,1,500000,'启用','2015-12-12');
INSERT INTO PRODUCT (ID,RRODUCT_DETAIL_ID,PRODUCT_TYPE,PRODUCT_NAME,PRODUCT_STATUS, YEAR_RATE,PRODUCT_DESC,TYPE_TERM,INVEST_MIN_AMOUNT,INVEST_MAX_AMOUNT,ENABLE_STATUS,CREATE_DATE) 
            values ('2','2','1','灵活宝','开放中', 8, '1元起投 随进随出',6,1,500000,'启用','2015-12-12');
